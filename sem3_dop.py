...
dictionary = {'A':1, 'E':1, 'I':1, 'O':1, 'U' : 1, 'L' : 1, 'N' : 1,
    'S' : 1, 'T' : 1, 'R' : 1, 'D' : 2, 'G' : 2, 'B' : 3, 'C' : 3, 'M' : 3,
    'P' : 3, 'F' : 3, 'H' : 3, 'V' : 3, 'W' : 3, 'Y' : 3, 'K' : 5, 'J' : 8,
    'X' : 8, 'Q' : 10, 'Z' : 10, 'А' : 1, 'В':1, 'Е' : 1, 'И' : 1, 'Н' : 1,
    'О' : 1, 'Р' : 1, 'С' : 1, 'Т' : 1, 'Д' : 2, 'К' : 2, 'Л' : 2, 'М' : 2,
...
new_word = [x.upper() for x in word]
print(type(new_word))
print(new_word)
